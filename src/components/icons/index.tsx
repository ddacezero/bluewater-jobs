/**
 * SVG icon components for the Bluewater Jobs ATS.
 * Each icon is a typed React functional component accepting standard SVG/HTML attributes.
 */
...
export const DashIcon: FC<IconProps> = ({ className }) => (
...
export const PeopleIcon: FC<IconProps> = ({ className }) => (
  <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const PipeIcon: FC<IconProps> = ({ className }) => (
  <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const PoolIcon: FC<IconProps> = ({ className }) => (
  <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const StarIcon: FC<StarIconProps> = ({ filled, className }) => (
  <svg className={className} width="14" height="14" viewBox="0 0 24 24" fill={filled ? "#F59E0B" : "none"} stroke={filled ? "#F59E0B" : "#CBD5E1"} strokeWidth="2">
...
export const LocIcon: FC<IconProps> = ({ className }) => (
...
export const UpIcon: FC<IconProps> = ({ className }) => (
  <svg className={className} width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#16a34a" strokeWidth="2.5">
...
export const ChevIcon: FC<IconProps> = ({ className, style }) => (
...
export const EndorseIcon: FC<IconProps> = ({ className }) => (
  <svg className={className} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const CalIcon: FC<IconProps> = ({ className }) => (
  <svg className={className} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const TrophyIcon: FC<IconProps> = ({ className }) => (
  <svg className={className} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const ClipboardIcon: FC<IconProps> = ({ className }) => (
  <svg className={className} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const ListCheckIcon: FC<IconProps> = ({ className }) => (
  <svg className={className} width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M10 6h11" />
    <path d="M10 12h11" />
    <path d="M10 18h11" />
