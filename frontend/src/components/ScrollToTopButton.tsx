...
const ScrollToTopButton: FC = () => {
  ...
  return (
    <button
      onClick={scrollToTop}
      title="Scroll to top"
      className="fixed bottom-6 right-6 z-50 w-10 h-10 rounded-full bg-[var(--color-primary)] text-white shadow-[var(--shadow-btn)] flex items-center justify-center cursor-pointer border-none transition-all duration-200 hover:bg-[var(--color-primary-hover)] hover:scale-110 animate-fade-in"
    >
