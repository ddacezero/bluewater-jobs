        ...
        <div className={`${mob ? "px-5 py-5" : "px-7 py-6"} flex flex-col gap-5`}>
          ...
          <div className="border-t border-[var(--color-surface-border)] pt-5">
            ...
            <div className={`flex gap-2.5 ${mob ? "flex-col" : ""}`}>
              ...
              <button
                className="bg-[var(--color-primary)] text-white rounded-[var(--radius-md)] px-5 py-2.5 text-[13.5px] font-semibold shadow-[var(--shadow-btn)] cursor-pointer inline-flex items-center gap-2 disabled:opacity-50 transition-colors"
                disabled
                title="Talent pool reactivation is not part of the current backend scope."
              >
                <RedoIcon /> Reactivate
              </button>
            </div>
            <p className="mt-2 text-[12px] text-[var(--color-text-muted)]">
              Talent pool reactivation is still mock-only and is not wired to the current backend contract.
            </p>
          </div>
        </div>
      </div>
